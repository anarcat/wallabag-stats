...
func generateOutput(wbgStats *WallabagStats) {
	...
	isDayGen, isWeekGen, isMonthGen, isYearGen, isOverallGen := generateCharts(wbgStats)
	generateHTML(wbgStats, isDayGen, isWeekGen, isMonthGen, isYearGen, isOverallGen)
}
